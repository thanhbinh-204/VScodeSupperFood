...
const nextQc3 = () =>{
  ...
  return (
    <View>
        ...
        />
      <Text style={{alignSelf:'center',justifyContent:'center',color:'#F54749',fontWeight:'600',fontSize:20,marginTop:30,}}>Choose favorite dishes!</Text>
